...
class RegressionOrchestratorTest(unittest.TestCase):
    ...
    def test_html_report_contains_images_baselines_and_model_evidence(self):
        ...
        self.assertIn("What this run actually did", page)
        self.assertIn("Designer-generated frames", page)
    ...
    def test_offline_parity_uses_fake_printer_artifacts_without_network(self):
        with tempfile.TemporaryDirectory() as temporary:
            ...
            self.assertIn("Real printer framebuffer frames", page)
            self.assertIn("Designer / printer parity pairs", page)
            self.assertIn(
