...
| Display modes and first-party Feather | [Screen modes and Feather](workflows/screens-and-feather.md) | [Feather runtime and Typer wiring](workflows/feather-runtime.md), `config/*.cfg`, `.cfg/init.display.*.cfg`, `.shell/commands/zdisplay.sh`, `.py/klipper/plugins/feather_screen.py` | Selects configuration/boot path; explains Feather’s renderer/status implementation and recovery constraints. |
